...
category, and add search, sorting and extra columns to CloudPanel's own Sites
page in [CloudPanel](https://www.cloudpanel.io/). Access uses your existing
administrator login.
...
| Panel Tweaks | Small additions to CloudPanel's own pages: a site count, search, sorting, SSL, runtime and measured size columns, a device theme on the login page, and one-click WordPress sign-in. |
...
`php-resources`, and `panel-tweaks`. Run
