...
category, point retired domains at their replacements, and set the initial login
theme from the device preference in
...
| Redirects | Create sites whose only job is a 301 or 302 to another URL, and keep them redirecting when CloudPanel regenerates their vhost. |
...
`php-resources`, `redirects`, and `login-theme`. Run
